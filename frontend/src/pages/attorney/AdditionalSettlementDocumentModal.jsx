...
export default function AdditionalSettlementDocumentModal({ caseId, onClose, onSent }) {
  ...
  function chooseFile(candidate) {
    ...
    if (!isSupported) {
      setError('Choose a PDF, DOCX, or DOC document.');
      return;
    }
