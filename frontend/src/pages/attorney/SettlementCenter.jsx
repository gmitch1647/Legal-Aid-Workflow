...
export default function SettlementCenter() {
  ...
  const openAttorneyDelivery = async (caseId = selectedCaseId) => {
    setDeliveryCaseId(caseId || '');
    setNotice('');
    setError('');
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      {preparedSendTarget && (
        <PreparedSettlementPackageSendModal
          ...
          onSent={async (result) => {
            ...
            await loadWorkflow(deliveryCaseId || selectedCaseId);
      ...
      {showAttorneyDelivery && selectedCase && (
        <CompletedSettlementDeliveryModal
          caseRow={cases.find((caseRow) => String(caseRow.id) === String(deliveryCaseId)) || selectedCase}
